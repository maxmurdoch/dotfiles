...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#ffffff" :foreground "#373b41" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight light :height 110 :width extra-condensed :foundry "nil" :family "Input Mono Narrow"))))
 '(fringe ((t (:background "gray100"))))
 '(hl-line ((t (:inherit highlight :background "gray93"))))
